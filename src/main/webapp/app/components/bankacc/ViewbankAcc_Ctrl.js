(function () {
    var ViewbankAcc_Ctrl = function ($scope, $uibModalInstance, CLIENT, Core_Service, clientDetails) {
    ...
    ViewbankAcc_Ctrl.$inject = ["$scope", '$uibModalInstance', 'CLIENT',
        'Core_Service', 'candidateDetails'];
    angular.module('coreModule').controller('ViewbankAcc_Ctrl', ViewbankAcc_Ctrl);
})();