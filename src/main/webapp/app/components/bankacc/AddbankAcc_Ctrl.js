(function () {
    var AddbankAcc_Ctrl = function ($scope, $state, $rootScope, Core_Service, $stateParams, Core_HttpRequest, validationService) {
        var vm = this;
    ...
    angular.module('coreModule')
            .controller('AddbankAcc_Ctrl', AddbankAcc_Ctrl);
})();