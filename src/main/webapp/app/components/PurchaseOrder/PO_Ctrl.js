(function () {
    var PO_Ctrl = function ($scope, $state, $rootScope, Core_Service, urlConfig, Core_ModalService) {
        ...
        vm.viewPO = function (data) {
            Core_ModalService.openViewPOModal(data);
        };
    };
    PO_Ctrl.$inject = ["$scope", '$state', '$rootScope', 'Core_Service', 'urlConfig', 'Core_ModalService'];
