...
import com.belhopat.backoffice.alfresco.oauth.LocalServerReceiver;
import com.belhopat.backoffice.alfresco.oauth.VerificationCodeReceiver;
 ...
 * @author jpotts
 */
public class BaseCloudFns extends BaseCoreAPIFns {
    ...
    public Credential authorize(VerificationCodeReceiver receiver, String redirectUri)
            ...
            AuthorizationCodeFlow codeFlow = new AuthorizationCodeFlow.Builder(
                    ...
                    new ClientParametersAuthentication(
                        BaseCloudFns.getAPIKey(), BaseCloudFns.getAPISecret()),
                    BaseCloudFns.getAPIKey(),
