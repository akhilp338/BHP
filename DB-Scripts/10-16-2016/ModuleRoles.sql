...
INSERT INTO `BHP_BACK_OFFICE`.`MODULE_TAB` (`TAB_ICON`, `TAB_LABEL`, `TAB_NAME`, `TAB_STATE`, `TAB_TITLE`) VALUES ('fa-dashboard', 'Dashboard', 'dashboard', 'coreuser.dashboard', 'Dashboard');
INSERT INTO `BHP_BACK_OFFICE`.`MODULE_TAB` (`TAB_ICON`, `TAB_LABEL`, `TAB_NAME`, `TAB_STATE`, `TAB_TITLE`) VALUES ('fa-briefcase', 'Candidate Management', 'candidate', 'coreuser.candidate', 'Candidate Management');
...
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '1');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '2');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '3');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '4');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '5');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '6');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '7');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '8');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '9');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '10');
INSERT INTO `BHP_BACK_OFFICE`.`ROLE_MODULE_TAB` (`ROLE_ID`, `MODULE_TAB_ID`) VALUES ('1', '11');
